...
local icon_dir = gfs.get_configuration_dir() .. "themes/default/titlebar/"
...
theme.titlebar_maximized_button_normal_active = icon_dir .. "maximized_focus_hover.svg"
theme.titlebar_maximized_button_focus_active = icon_dir .. "maximized_focus_hover.svg"
